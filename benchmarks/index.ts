...
async function runBenchmarks() {
    ...
    console.log(`SET: ${opsPerSecSet.toLocaleString()} ops/sec (${(endSet - startSet).toFixed(2)}ms)`);
    ...
    console.log(`GET: ${opsPerSecGet.toLocaleString()} ops/sec (${(endGet - startGet).toFixed(2)}ms)`);
    ...
    console.log(`DELETE: ${opsPerSecDel.toLocaleString()} ops/sec (${(endDel - startDel).toFixed(2)}ms)`);
